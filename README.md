...
- `src/assets/fonts`: PP Eiko (Medium, Thin) and PP Neue Montreal (Regular, Light, Text Book), converted to WOFF2.
- `src/assets/images`: the logo and The Optimist wordmark exported from Figma, plus the grain tile.
